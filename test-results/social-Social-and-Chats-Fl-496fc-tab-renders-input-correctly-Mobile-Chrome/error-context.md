...
- Name: social.spec.ts >> Social and Chats Flow UI >> search tab renders input correctly
- Location: tests/social.spec.ts:31:7
...
Call log:
  - navigating to "http://localhost:3000/social", waiting until "load"
