        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between max-w-7xl mx-auto gap-4">
          ...
          <div className="flex items-center gap-2 w-full md:w-auto overflow-x-auto pb-1 md:pb-0">
            <button
              ...
              className="flex-1 md:flex-none px-4 md:px-5 py-2.5 bg-indigo-50 text-indigo-700 rounded-full text-xs font-bold shadow-sm border border-indigo-100 hover:bg-indigo-100 transition-colors flex items-center justify-center gap-1.5"
            >
              <Send size={14} />
              Test Push
            </button>
