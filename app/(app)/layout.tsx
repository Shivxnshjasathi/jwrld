...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  if (loading && isFirebaseConfigured) {
    return (
      <div className="min-h-dvh flex items-center justify-center bg-obsidian">
  ...
  return (
    <div className={`w-full flex-1 flex flex-col min-h-dvh bg-obsidian text-on-surface ${showBottomNav ? 'pb-[var(--bottom-nav-height)]' : ''}`}>
      {children}
      <LiveSessionWidget />
